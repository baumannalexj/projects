package trafficlightsimulator.ui;
...
public final class PopupUI implements UI {
	...
	public String[] processForm(UIForm form) {
		...
		String userInput;
		String[] listValidResponses = new String[form.size()];
		for (int i = 0; i < form.size(); i++){
			userInput = JOptionPane.showInputDialog(form.getPrompt(i));
			if ( form.checkInput( i,  userInput) ) {
				listValidResponses[i] = userInput;
			}
		}
		
		return listValidResponses;
	}
}
